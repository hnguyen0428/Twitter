...
class APIManager: SessionManager {
    ...
    static let consumerKey = "L1J7oymz33Y78imIs2ExKOQ2c"
    static let consumerSecret = "FYjXQwFgBv0DgGrOYNODfSMC7QxruX6NljtvtJasUMk8ZQWOEe"
    ...
    func getBanner(userId: Int, completion: @escaping (URL?, Error?) -> ()) {
        let parameters = ["user_id": userId]
        request(URL(string: "https://api.twitter.com/1.1/users/profile_banner.json")!, parameters: parameters)
            .validate()
            .responseJSON { response in
                switch response.result {
                case .failure(let error):
                ...
                case .success:
                    ...
                    let sizes = dictionary["sizes"] as? [String:Any]
                    let mobileRetina = sizes?["mobile_retina"] as? [String:Any]
                    let url = mobileRetina?["url"] as? String
...
//        }
    ...
    func favorite(_ tweet: Tweet, completion: ((Tweet?, Error?) -> ())?) {
    ...
    func unfavorite(_ tweet: Tweet, completion: ((Tweet?, Error?) -> ())?) {
    ...
    func retweet(_ tweet: Tweet, completion: ((Tweet?, Error?) -> ())?) {
    ...
    func unretweet(_ tweet: Tweet, completion: ((Tweet?, Error?) -> ())?) {
